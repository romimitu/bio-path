    ...
    <section id="home">
      ...
      <div id="main-slide" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="item active">
            ...
            <div class="slider-content">
              <div class="col-md-12 text-center">
                <h2 class="animated2">
                              <span>Welcome to <strong>Bio-Path</strong></span>
                              </h2>
                <h3 class="animated3">
          ...
          <!--/ Carousel item end -->
          <div class="item">
            <img class="img-responsive" src="images/slider/sl2.jpg" alt="slider">
            <div class="slider-content">
              <div class="col-md-12 text-center">
                <h2 class="animated4">
                ...
                <p class="animated6"><a href="#" class="slider btn btn-system btn-large">Test List</a>
                </p>
              </div>
            </div>
          </div>
          <!--/ Carousel item end -->
          <div class="item">
            <img class="img-responsive" src="images/slider/sl3.jpg" alt="slider">
            <div class="slider-content">
              <div class="col-md-12 text-center">
